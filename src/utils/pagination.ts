...
export class Pagination {
  static getOffsetAndLimit(page: number = DEFAULT_PAGE, size: number = DEFAULT_PAGE_SIZE): any {
    page = Number(page)
    size = Number(size)
  ...
  static preparePaginationMetaData(page: number = DEFAULT_PAGE, size: number = DEFAULT_PAGE_SIZE, totalCount: number): IMetaData {
    page = Number(page)
    size = Number(size)
