...
export default class Connector {
    ...
    // TODOD: This is a dummy function to verify the transaction payload by hitting the blockchain and comparing the recived file. As of now I am unable to do this via the SDK
