...
export const fetchIncompleteTransactionsJob = () => {
  fetchIncompleteTransactions.add(FETCH_INCOMPLETE_TRANSACTIONS_PROCESS, {}, {
...
export const addFetchTransactionDetailsJob = (transactionHash: string) => {
  fetchTransactionDetailsQueue.add(FETCH_TRANSACTION_DETAILS_PROCESS, { transactionHash }, {
...
export const addFetchAndVerifyFileDetailsJob = (fileMetadata) => {
  fetchAndVerifyFileDetailsQueue.add(FETCH_AND_VERIFY_FILE_DETAILS_PROCESS, { fileMetadata }, {
